 ...
 *
 * Notion-stijl layout component voor de Vibecode Core kennisbank.
 * Bevat een fixed sidebar met navigatie en een gecentreerd content area.
 *
 * @component
 * @example
 * <VibecodeLayoutNotion>
...
interface VibecodeLayoutNotionProps {
  children: ReactNode
}
...
export default function VibecodeLayoutNotion({ children }: VibecodeLayoutNotionProps) {
