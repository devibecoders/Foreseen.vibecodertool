-- =====================================================
-- Migration 012: Articles, Scans, Analyses, Sources
-- Replaces Prisma/SQLite with Supabase for Lovable
-- =====================================================
...
-- 5. Decision Assessments table (for Decisions layer)
...
-- =====================================================
-- Enable RLS (permissive for now, strict auth later)
-- =====================================================
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_decision_assessments_updated_at') THEN
...
-- =====================================================
-- Seed default sources for AI news
-- =====================================================
